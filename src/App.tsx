...
export default function App() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (u) {
        // The onAuthStateChanged listener handles the redirection and role fetching
        // We just ensure the user document exists for roles
                ...
                <Card className="bg-white/80 backdrop-blur-xl border border-white rounded-[3rem] shadow-2xl p-8 md:p-12">
                  ...
                  <div className="mt-6 flex flex-col gap-4">
                    <div className="relative flex items-center justify-center">
                      ...
                      <span className="relative px-4 bg-white text-[9px] font-black text-slate-300 uppercase tracking-widest">Or Secure Login via</span>
                    </div>
                    ...
                    <Button 
                      ...
                      disabled={isAuthenticating}
                      className="w-full h-14 border-slate-100 bg-white hover:bg-slate-50 text-slate-600 rounded-2xl font-bold text-xs flex items-center justify-center gap-3 transition-all"
                    >
          ...
          {isMobileMenuOpen && (
            ...
            >
               ...
               <nav className="flex flex-col gap-8">
                  ...
                  <Button onClick={handleGoogleLogin} className="w-full h-20 bg-white text-[#002F5C] rounded-2xl font-black text-xl uppercase tracking-widest">Sign in</Button>
               </nav>
            </motion.div>
          )}
        </AnimatePresence>
